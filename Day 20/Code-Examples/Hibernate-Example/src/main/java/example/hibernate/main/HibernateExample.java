...
public class HibernateExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			LocalDate publicationDate = LocalDate.of(2022, 7, 22);
			Article currentArticle = new Article(101, "IT Jobs in India", publicationDate);
			//Article currentArticle2 = new Article(102, "xyz", LocalDate.now());
			...
			hibernateTransaction = hibernateSession.beginTransaction();
				...
				//hibernateSession.save(currentArticle2);
